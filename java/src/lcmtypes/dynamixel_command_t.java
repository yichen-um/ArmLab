...
public final class dynamixel_command_t implements lcm.lcm.LCMEncodable
{
    ...
    {
        if (classes.contains(lcmtypes.dynamixel_command_t.class))
            return 0L;
 
        classes.add(lcmtypes.dynamixel_command_t.class);
    ...
    public static lcmtypes.dynamixel_command_t _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        lcmtypes.dynamixel_command_t o = new lcmtypes.dynamixel_command_t();
    ...
    public lcmtypes.dynamixel_command_t copy()
    {
        lcmtypes.dynamixel_command_t outobj = new lcmtypes.dynamixel_command_t();
