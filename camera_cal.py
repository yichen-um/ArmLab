...
# termination criteria for finding fit (type, max_iter, epsilon)
# stop the iteration if either the epsilon or the max iterations allowed is reached
criteria = (cv2.TERM_CRITERIA_EPS + cv2.TERM_CRITERIA_MAX_ITER, 30, 0.001) # K-means clustering
