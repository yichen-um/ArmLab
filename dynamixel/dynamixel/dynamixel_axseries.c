...
static void
axseries_config(dynamixel_device_t *device, 
                char kp, 
                char ki, 
                char kd, 
                char compl_margin, 
                ...
                char LED)
{
    dynamixel_msg_t *msg = dynamixel_msg_create(6);
    msg->buf[0] = 0x19;
    msg->buf[1] = LED ? 0x00 : 0x01;
    msg->buf[2] = compl_margin;
    msg->buf[3] = compl_margin;
    msg->buf[4] = compl_slope;
    msg->buf[5] = compl_slope;
    dynamixel_msg_t *resp = device->write_to_RAM(device,msg,0);
