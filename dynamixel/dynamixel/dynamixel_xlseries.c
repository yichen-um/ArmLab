...
static void
xlseries_config(dynamixel_device_t *device, 
                char kp, 
                char ki, 
                char kd, 
                char compl_margin, 
                ...
                char LED)
{
    dynamixel_msg_t *msg = dynamixel_msg_create(8);
    msg->buf[0] = 0x19;
    msg->buf[1] = 0x00;
    msg->buf[2] = LED;
    msg->buf[3] = 0x00;
...
/*static void
xlseries_set_id(dynamixel_device_t *device, int newid)
{
