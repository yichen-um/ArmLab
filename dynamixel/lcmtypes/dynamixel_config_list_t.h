...
#ifndef _dynamixel_config_list_t_h
#define _dynamixel_config_list_t_h
...
typedef struct _dynamixel_config_list_t dynamixel_config_list_t;
struct _dynamixel_config_list_t
{
    int32_t    len;
    dynamixel_config_t *configs;
};

/**
 * Create a deep copy of a dynamixel_config_list_t.
 * When no longer needed, destroy it with dynamixel_config_list_t_destroy()
 */
dynamixel_config_list_t* dynamixel_config_list_t_copy(const dynamixel_config_list_t* to_copy);

/**
 * Destroy an instance of dynamixel_config_list_t created by dynamixel_config_list_t_copy()
 */
void dynamixel_config_list_t_destroy(dynamixel_config_list_t* to_destroy);

/**
 * Identifies a single subscription.  This is an opaque data type.
 */
typedef struct _dynamixel_config_list_t_subscription_t dynamixel_config_list_t_subscription_t;

/**
 * Prototype for a callback function invoked when a message of type
 * dynamixel_config_list_t is received.
 */
typedef void(*dynamixel_config_list_t_handler_t)(const lcm_recv_buf_t *rbuf,
             const char *channel, const dynamixel_config_list_t *msg, void *userdata);

/**
 * Publish a message of type dynamixel_config_list_t using LCM.
 *
 ...
 */
int dynamixel_config_list_t_publish(lcm_t *lcm, const char *channel, const dynamixel_config_list_t *msg);

/**
 * Subscribe to messages of type dynamixel_config_list_t using LCM.
 *
 ...
 */
dynamixel_config_list_t_subscription_t* dynamixel_config_list_t_subscribe(lcm_t *lcm, const char *channel, dynamixel_config_list_t_handler_t handler, void *userdata);

/**
 * Removes and destroys a subscription created by dynamixel_config_list_t_subscribe()
 */
...
/**
 * Encode a message of type dynamixel_config_list_t into binary form.
 *
 * @param buf The output buffer.
 * @param offset Encoding starts at this byte offset into @p buf.
 * @param maxlen Maximum number of bytes to write.  This should generally
 *               be equal to dynamixel_config_list_t_encoded_size().
...
/**
 * Decode a message of type dynamixel_config_list_t from binary form.
 * When decoding messages containing strings or variable-length arrays, this
 * function may allocate memory.  When finished with the decoded message,
 * release allocated resources with dynamixel_config_list_t_decode_cleanup().
 *
 ...
 */
int dynamixel_config_list_t_decode(const void *buf, int offset, int maxlen, dynamixel_config_list_t *msg);

/**
 * Release resources allocated by dynamixel_config_list_t_decode()
 * @return 0
 */
int dynamixel_config_list_t_decode_cleanup(dynamixel_config_list_t *p);

/**
 * Check how many bytes are required to encode a message of type dynamixel_config_list_t
 */
